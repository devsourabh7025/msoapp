    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
          Assign 1 post per award category. Focus: Building prestige and community authority.
        </p>
      </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-6">
              <h3 className="text-sm font-bold text-gray-900 dark:text-white">Award Categories (1 post each)</h3>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        <input
                          ...
                          className="w-full px-3 py-2 text-sm font-bold border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded focus:outline-none focus:ring-2 focus:ring-red-500 mb-2"
                        />
                        <textarea
                    ...
                    {(sub.posts || []).length < POSTS_LIMIT && (
                      <button
                        ...
                        className="px-3 py-1.5 text-xs font-medium bg-red-600 hover:bg-red-700 text-white rounded shrink-0"
                      >
