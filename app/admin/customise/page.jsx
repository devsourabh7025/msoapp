...
function CustomiseContent() {
        ...
        if (response.ok) {
          ...
          if (data.hero) {
            console.log("✅ Loading hero content from API:", {
              ...
              topPicks: data.hero.topPicks?.map(p => ({ id: p._id, title: p.title })) || [],
              discussionTableCount: data.hero.discussionTable?.length || 0,
              discussionTable: data.hero.discussionTable?.map(p => ({ id: p._id, title: p.title })) || [],
            });
            setSectionContent((prev) => ({
              ...prev,
              hero: {
  ...
  const handleContentChange = (sectionId, field, value, itemId = null) => {
    setSectionContent((prev) => {
      ...
      if (itemId !== null) {
        ...
        // Add new item
        const newId = Math.max(...(newContent[sectionId].map((i) => i.id) || [0]), 0) + 1;
  ...
  const handleAddItem = (sectionId, defaultFields) => {
    const newId = Math.max(...(sectionContent[sectionId]?.map((i) => i.id) || [0]), 0) + 1;
    setSectionContent((prev) => ({
      ...prev,
      [sectionId]: [...(prev[sectionId] || []), { id: newId, ...defaultFields }],
    }));
                ...
                {loadingPosts ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400">
                                <span className="px-2 py-0.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded">
                                  {sectionContent.hero.mainArticle.category || "Uncategorized"}
                                </span>
                                <span>•</span>
                                <span>{sectionContent.hero.mainArticle.author?.name || "Unknown"}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      {showPostSelector.heroMain && !sectionContent.hero?.mainArticle && (
                    ...
                    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                      ...
                      {(sectionContent.hero?.topPicks || []).length > 0 ? (
                        <div className="space-y-2 mb-4">
                          {(sectionContent.hero?.topPicks || []).map((post, index) => (
                      ...
                      {(sectionContent.hero?.topPicks || []).length > 0 && (
                        <div className="text-center pt-3 border-t border-gray-200 dark:border-gray-800">
                          <span className="text-xs text-gray-600 dark:text-gray-400">
                            Selected: <span className="font-semibold text-gray-900 dark:text-white">{(sectionContent.hero?.topPicks || []).length} / 4</span>
                          </span>
                        </div>
                      )}
                      
                      {showPostSelector.heroTopPicks && (sectionContent.hero?.topPicks || []).length < 4 && (
                        <div className="mt-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
                          <div className="mb-4">
                            <label className="block text-xs font-semibold text-gray-900 dark:text-white mb-2">
                              Search Posts
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        setSectionContent((prev) => ({
                                          ...
                                          hero: {
                                            ...prev.hero,
                                            topPicks: [...(prev.hero?.topPicks || []), post],
                                          },
                                        }));
                    ...
                    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                      ...
                      {(sectionContent.hero?.discussionTable || []).length > 0 ? (
                        <div className="space-y-2 mb-4">
                          {(sectionContent.hero?.discussionTable || []).slice(0, 4).map((post) => (
                            <div key={post._id} className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded border border-gray-200 dark:border-gray-700">
                              <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                  <div className="w-1 h-12 bg-blue-600 rounded-full shrink-0"></div>
                      ...
                      {(sectionContent.hero?.discussionTable || []).length > 0 && (
                        <div className="text-center pt-3 border-t border-gray-200 dark:border-gray-800">
                          <span className="text-xs text-gray-600 dark:text-gray-400">
                            Selected: <span className="font-semibold text-gray-900 dark:text-white">{(sectionContent.hero?.discussionTable || []).length} posts (max 4)</span>
                          </span>
                        </div>
                      )}
                                    ...
                                    <div
                                      ...
                                      onClick={() => {
                                        ...
                                        setSectionContent((prev) => ({
                                          ...
                                          hero: {
                                            ...prev.hero,
                                            discussionTable: [...(prev.hero?.discussionTable || []), post],
                                          },
                                        }));
                                      }}
                                      className="p-3 border-b border-gray-200 dark:border-gray-800 cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-800 transition-colors"
                    ...
                    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                      <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Featured spotlight posts</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
                            onClick={() => setShowPostSelector(prev => ({ ...prev, spotlight: !prev.spotlight }))}
                            className="px-4 py-2 text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors"
                          >
                      ...
                      {(sectionContent.spotlight || []).length > 0 ? (
                        <div className="space-y-2 mb-4">
                          {(sectionContent.spotlight || []).map((post, index) => (
                            <div key={post._id || index} className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded border border-gray-200 dark:border-gray-700">
                              <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                  <div className="w-6 h-6 rounded bg-blue-600 text-white flex items-center justify-center shrink-0 text-xs font-semibold">
                                    {index + 1}
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded border border-gray-200 dark:border-gray-700 text-center mb-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400">No posts selected</p>
                          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Add spotlight articles to display</p>
                        </div>
                      )}
                      ...
                      {(sectionContent.spotlight || []).length > 0 && (
                        <div className="text-center pt-3 border-t border-gray-200 dark:border-gray-800">
                          <span className="text-xs text-gray-600 dark:text-gray-400">
                            Selected: <span className="font-semibold text-gray-900 dark:text-white">{(sectionContent.spotlight || []).length} posts</span>
                          </span>
                        </div>
                      )}
                        ...
                        <div className="mt-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
                          ...
                          <div className="max-h-64 overflow-y-auto border border-gray-200 dark:border-gray-800 rounded bg-white dark:bg-gray-900">
                            {searchQuery ? (
                              ...
                              <div className="p-8 text-center">
                                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Start typing to search</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500">Search posts by title to add to spotlight</p>
                              </div>
                            )}
                          </div>
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {(() => {
                      const renderSubsection = (subsectionKey, subsectionName, subsectionDescription) => {
                        ...
                        return (
                          <div key={subsectionKey} className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                            <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                              <div>
                                <h4 className="text-sm font-semibold text-gray-900 dark:text-white">
                                  {subsectionName}
                                </h4>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{subsectionDescription}</p>
                              </div>
                              <div className="flex items-center gap-2">
                                <button
                                  type="button"
                                  onClick={() => setShowPostSelector(prev => ({ ...prev, [selectorKey]: !prev[selectorKey] }))}
                                  className="px-4 py-2 text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors"
                                >
                                  ...
                                  <button
                                    ...
                                    onClick={() => {
                                      setSectionContent((prev) => ({
                                        ...prev,
                                        featured: {
                                          ...(prev.featured || { smbStories: [], herStories: [], socialStories: [] }),
                                          [subsectionKey]: [],
                                        },
                                      }));
                                    }}
                            ...
                            {posts.length > 0 ? (
                              ...
                              <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded border border-gray-200 dark:border-gray-700 text-center mb-4">
                                <p className="text-sm text-gray-500 dark:text-gray-400">No posts selected</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Add posts to {subsectionName.toLowerCase()}</p>
                              </div>
                            )}
                            ...
                            {posts.length > 0 && (
                              <div className="text-center pt-3 border-t border-gray-200 dark:border-gray-800">
                                <span className="text-xs text-gray-600 dark:text-gray-400">
                                  Selected: <span className="font-semibold text-gray-900 dark:text-white">{posts.length} posts</span>
                                </span>
                              </div>
                            )}
                              ...
                              <div className="mt-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
                                ...
                                <div className="max-h-64 overflow-y-auto border border-gray-200 dark:border-gray-800 rounded bg-white dark:bg-gray-900">
                                  {searchQuery ? (
                                          ...
                                          <div
                                            ...
                                            onClick={() => {
                                              setSectionContent((prev) => ({
                                                ...
                                                featured: {
                                                  ...(prev.featured || { smbStories: [], herStories: [], socialStories: [] }),
                                                  [subsectionKey]: [...(prev.featured?.[subsectionKey] || []), post],
                                                },
                                              }));
                                            }}
                                            className="p-3 border-b border-gray-200 dark:border-gray-800 cursor-pointer hover:bg-blue-50 dark:hover:bg-gray-800 transition-colors"
                                    ...
                                    <div className="p-8 text-center">
                                      <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Start typing to search</p>
                                      <p className="text-xs text-gray-400 dark:text-gray-500">Search posts by title to add to {subsectionName.toLowerCase()}</p>
                                    </div>
                                  )}
                                </div>
                              </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                      <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Select posts for explore section</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
                            onClick={() => setShowPostSelector(prev => ({ ...prev, explore: !prev.explore }))}
                            className="px-4 py-2 text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors"
                          >
                            {showPostSelector.explore ? "Cancel" : "Add Post"}
                          </button>
                          {(sectionContent.explore || []).length > 0 && (
                            <button
                              type="button"
                              onClick={() => {
                                setSectionContent((prev) => ({
                      ...
                      {(sectionContent.explore || []).length > 0 ? (
                        <div className="space-y-2 mb-4">
                          {(sectionContent.explore || []).map((post, index) => (
                            <div key={post._id || index} className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded border border-gray-200 dark:border-gray-700">
                              <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-3 flex-1 min-w-0">
                                  <div className="w-6 h-6 rounded bg-blue-600 text-white flex items-center justify-center shrink-0 text-xs font-semibold">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded border border-gray-200 dark:border-gray-700 text-center mb-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400">No posts selected</p>
                          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Add explore articles to display</p>
                        </div>
                      )}
                      ...
                      {(sectionContent.explore || []).length > 0 && (
                        <div className="text-center pt-3 border-t border-gray-200 dark:border-gray-800">
                          <span className="text-xs text-gray-600 dark:text-gray-400">
                            Selected: <span className="font-semibold text-gray-900 dark:text-white">{(sectionContent.explore || []).length} posts</span>
                          </span>
                        </div>
                      )}
                      
                      {showPostSelector.explore && (
                        <div className="mt-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
                          <div className="mb-4">
                            <label className="block text-xs font-semibold text-gray-900 dark:text-white mb-2">
                              Search Posts
                          ...
                          <div className="max-h-64 overflow-y-auto border border-gray-200 dark:border-gray-800 rounded bg-white dark:bg-gray-900">
                            {searchQuery ? (
                              ...
                              <div className="p-8 text-center">
                                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Start typing to search</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500">Search posts by title to add to explore</p>
                              </div>
                            )}
                          </div>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border border-gray-200 dark:border-gray-800">
                      <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200 dark:border-gray-800">
                        <div>
                          ...
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Select posts for trending section</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <button
                            type="button"
                            onClick={() => setShowPostSelector(prev => ({ ...prev, trending: !prev.trending }))}
                            className="px-4 py-2 text-xs font-medium bg-blue-600 hover:bg-blue-700 text-white rounded transition-colors"
                          >
                      ...
                      {(sectionContent.trending || []).length > 0 ? (
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800/50 p-6 rounded border border-gray-200 dark:border-gray-700 text-center mb-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400">No posts selected</p>
                          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Add trending articles to display</p>
                        </div>
                      )}
                      ...
                      {(sectionContent.trending || []).length > 0 && (
                        <div className="text-center pt-3 border-t border-gray-200 dark:border-gray-800">
                          <span className="text-xs text-gray-600 dark:text-gray-400">
                            Selected: <span className="font-semibold text-gray-900 dark:text-white">{(sectionContent.trending || []).length} posts</span>
                          </span>
                        </div>
                      )}
                        ...
                        <div className="mt-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
                          ...
                          <div className="max-h-64 overflow-y-auto border border-gray-200 dark:border-gray-800 rounded bg-white dark:bg-gray-900">
                            {searchQuery ? (
                              ...
                              <div className="p-8 text-center">
                                <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Start typing to search</p>
                                <p className="text-xs text-gray-400 dark:text-gray-500">Search posts by title to add to trending</p>
                              </div>
                            )}
                          </div>
                        </div>
  ...
  const enabledSections = sectionOrder.filter((section) => 
    section.enabled && section.id !== "discover" && section.id !== "ecosystem"
  );
    ...
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">
          {displaySection ? `${displaySection.name} Section` : "Homepage Sections"}
        </h1>
      ...
      {displaySection ? (
            ...
            <div className="p-6">
              ...
              <div>
                <div className="mb-4 pb-3 border-b border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-2">
                    {React.createElement(sectionIcons[displaySection.id] || Layout, { size: 18, className: "text-red-600 dark:text-red-400" })}
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">{displaySection.name}</h2>
                  </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <div className="text-center py-12">
            <p className="text-gray-500 dark:text-gray-400">Please select a section from the admin sidebar to edit.</p>
          </div>
        </div>
      )}
    </div>
  ...
  return (
    <Suspense fallback={
      <div className="flex items-center justify-center py-12">
        <div className="text-sm text-gray-500">Loading customization page...</div>
      </div>
    }>
      <CustomiseContent />
    </Suspense>
