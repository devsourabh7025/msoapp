...
function optimizeContentData(content) {
    if (!content || typeof content !== 'object') {
        /* eslint-disable */ console.log(...oo_oo(`2744040603_43_4_43_68_4`, "⚠️ optimizeContentData: Invalid content:", content));
        return content;
    }
    const optimized = {
        ...content
    ...
    if (optimized.hero) {
        /* eslint-disable */ console.log(...oo_oo(`2744040603_51_4_55_6_4`, "🔍 Optimizing hero section:", {
        ...
        /* eslint-disable */ console.log(...oo_oo(`2744040603_67_4_67_48_4`, "⚠️ No hero section in content"));
    }
...
async function GET() {
    try {
        ...
        /* eslint-disable */ console.log(...oo_oo(`2744040603_180_4_194_6_4`, "🔍 Homepage API Response:", {
        ...
        /* eslint-disable */ console.error(...oo_tx(`2744040603_204_4_204_61_11`, "Error fetching homepage settings:", error));
...
async function PUT(request) {
    try {
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`2744040603_233_6_233_62_11`, "Error parsing request body:", parseError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`2744040603_302_6_302_58_11`, "Database connection error:", dbError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`2744040603_316_6_316_55_11`, "Authentication error:", authError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            const saveOperation = async ()=>{
                ...
                const saveWithRetry = async (key, value, type, maxRetries = 2)=>{
                    for(let attempt = 1; attempt <= maxRetries; attempt++){
                        try {
                            /* eslint-disable */ console.log(...oo_oo(`2744040603_341_14_341_96_4`, `💾 Saving ${type} to database... (Attempt ${attempt}/${maxRetries})`));
                            ...
                            /* eslint-disable */ console.log(...oo_oo(`2744040603_349_14_349_56_4`, `✅ ${type} saved to database`));
                            return result;
                        } catch (error) {
                            /* eslint-disable */ console.error(...oo_tx(`2744040603_352_14_352_104_11`, `❌ Failed to save ${type} to database (Attempt ${attempt}):`, error.message));
                ...
                if (heroToSave !== null) {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`2744040603_389_10_399_12_4`, "💾 Saving hero section to database (separate setting):", {
                        heroSection: {
                            hasMainArticle: !!optimizedHero?.mainArticle,
                ...
                if (spotlightToSave !== null) {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`2744040603_408_10_413_12_4`, "💾 Saving spotlight section to database (separate setting):", {
                        spotlightSection: {
            ...
            /* eslint-disable */ console.error(...oo_tx(`2744040603_433_6_433_59_11`, "Database operation error:", dbOpError));
            /* eslint-disable */ console.error(...oo_tx(`2744040603_434_6_434_56_11`, "Save results so far:", saveResults));
        ...
        /* eslint-disable */ console.error(...oo_tx(`2744040603_461_4_461_59_11`, "Error saving homepage settings:", error));
        /* eslint-disable */ console.error(...oo_tx(`2744040603_462_4_462_46_11`, "Error stack:", error.stack));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0841f33b._.js.map