...
function isConnected() {
    return __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].connection.readyState === 1;
}
async function connectDB() {
    // If mongoose is already connected, return immediately (no need to check cache)
    if (isConnected()) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].connection;
    }
    ...
    cached.promise = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].connect(mongoUri, {
    ...
    try {
        cached.conn = await cached.promise;
        /* eslint-disable */ console.log(...oo_oo(`2970984172_74_4_74_50_4`, "✅ Mongoose connected to MongoDB"));
        // Handle connection events
        __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].connection.on("error", (err)=>{
            /* eslint-disable */ console.error(...oo_tx(`2970984172_78_6_78_53_11`, "MongoDB connection error:", err));
            cached.conn = null;
            cached.promise = null;
        });
        ...
        cached.promise = null;
        cached.conn = null;
        /* eslint-disable */ console.error(...oo_tx(`2970984172_93_4_93_57_11`, "Failed to connect to MongoDB:", error));
        // Provide more helpful error messages
        if (error.code === "ECONNREFUSED") {
            /* eslint-disable */ console.error(...oo_tx(`2970984172_97_6_103_7_11`, "❌ MongoDB connection refused. Please check:\n" + "1. Your MongoDB Atlas cluster is running\n" + "2. Your IP address is whitelisted in MongoDB Atlas\n" + "3. Your connection string is correct\n" + "4. Your network connection is working"));
        } else if (error.name === "MongoServerError") {
            /* eslint-disable */ console.error(...oo_tx(`2970984172_105_6_105_61_11`, "❌ MongoDB server error:", error.message));
        } else if (error.name === "MongoNetworkError") {
            /* eslint-disable */ console.error(...oo_tx(`2970984172_107_6_107_62_11`, "❌ MongoDB network error:", error.message));
        }
        throw error;
    }
}
...
"[project]/app/api/settings/homepage/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function optimizeContentData(content) {
    if (!content || typeof content !== 'object') {
        /* eslint-disable */ console.log(...oo_oo(`1679218982_43_4_43_68_4`, "⚠️ optimizeContentData: Invalid content:", content));
        return content;
    }
    const optimized = {
        ...content
    ...
    if (optimized.hero) {
        /* eslint-disable */ console.log(...oo_oo(`1679218982_51_4_55_6_4`, "🔍 Optimizing hero section:", {
        ...
        /* eslint-disable */ console.log(...oo_oo(`1679218982_67_4_67_48_4`, "⚠️ No hero section in content"));
    }
    ...
    try {
        ...
        const dbOperation = async ()=>{
            ...
            const [orderSettings, settingsData, contentData, heroContentData, spotlightContentData] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    key: "homepageSectionOrder"
                }).maxTimeMS(5000),
                __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    key: "homepageSectionSettings"
                }).maxTimeMS(5000),
                __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    key: "homepageSectionContent"
                }).maxTimeMS(5000),
                __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    key: "homepageHeroContent"
                }).maxTimeMS(5000),
                __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        if (heroContentData?.value) {
            optimizedHero = {
                ...
                topPicks: Array.isArray(heroContentData.value.topPicks) ? heroContentData.value.topPicks.map(optimizePostData) : [],
                discussionTable: Array.isArray(heroContentData.value.discussionTable) ? heroContentData.value.discussionTable.map(optimizePostData) : []
            };
        } else {
            optimizedHero = {
                mainArticle: null,
        ...
        if (spotlightContentData?.value) {
            optimizedSpotlight = Array.isArray(spotlightContentData.value) ? spotlightContentData.value.map(optimizePostData) : [];
        } else {
            optimizedSpotlight = [];
        }
        // Debug logging after optimization
        /* eslint-disable */ console.log(...oo_oo(`1679218982_180_4_194_6_4`, "🔍 Homepage API Response:", {
        ...
        /* eslint-disable */ console.error(...oo_tx(`1679218982_204_4_204_61_11`, "Error fetching homepage settings:", error));
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            status: 200
        }); // Return 200 with empty data so components can handle gracefully
    }
}
async function PUT(request) {
    try {
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`1679218982_233_6_233_62_11`, "Error parsing request body:", parseError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`1679218982_302_6_302_58_11`, "Database connection error:", dbError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            ...
            decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, JWT_SECRET);
            user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(decoded.userId).select("-password");
        } catch (authError) {
            /* eslint-disable */ console.error(...oo_tx(`1679218982_316_6_316_55_11`, "Authentication error:", authError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            const saveOperation = async ()=>{
                ...
                const saveWithRetry = async (key, value, type, maxRetries = 2)=>{
                    for(let attempt = 1; attempt <= maxRetries; attempt++){
                        try {
                            /* eslint-disable */ console.log(...oo_oo(`1679218982_341_14_341_96_4`, `💾 Saving ${type} to database... (Attempt ${attempt}/${maxRetries})`));
                            ...
                            /* eslint-disable */ console.log(...oo_oo(`1679218982_349_14_349_56_4`, `✅ ${type} saved to database`));
                            return result;
                        } catch (error) {
                            /* eslint-disable */ console.error(...oo_tx(`1679218982_352_14_352_104_11`, `❌ Failed to save ${type} to database (Attempt ${attempt}):`, error.message));
                ...
                if (heroToSave !== null) {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`1679218982_389_10_399_12_4`, "💾 Saving hero section to database (separate setting):", {
                        heroSection: {
                            hasMainArticle: !!optimizedHero?.mainArticle,
                ...
                if (spotlightToSave !== null) {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`1679218982_408_10_413_12_4`, "💾 Saving spotlight section to database (separate setting):", {
                        spotlightSection: {
            ...
            /* eslint-disable */ console.error(...oo_tx(`1679218982_433_6_433_59_11`, "Database operation error:", dbOpError));
            /* eslint-disable */ console.error(...oo_tx(`1679218982_434_6_434_56_11`, "Save results so far:", saveResults));
            ...
            if (dbOpError.message?.includes("timeout") || dbOpError.name === "MongoNetworkTimeoutError") {
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ...
                    message: "The operation took too long. Please check your MongoDB connection and try again."
                }, {
                    status: 504
                });
            }
        ...
        /* eslint-disable */ console.error(...oo_tx(`1679218982_461_4_461_59_11`, "Error saving homepage settings:", error));
        /* eslint-disable */ console.error(...oo_tx(`1679218982_462_4_462_46_11`, "Error stack:", error.stack));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__623dc076._.js.map