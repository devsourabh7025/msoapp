...
async function connectDB() {
    ...
    try {
        cached.conn = await cached.promise;
        /* eslint-disable */ console.log(...oo_oo(`3380632222_75_4_75_50_4`, "✅ Mongoose connected to MongoDB"));
        ...
        __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connection.on("error", (err)=>{
            /* eslint-disable */ console.error(...oo_tx(`3380632222_79_6_79_53_11`, "MongoDB connection error:", err));
            cached.conn = null;
            cached.promise = null;
        });
        ...
        cached.promise = null;
        cached.conn = null;
        /* eslint-disable */ console.error(...oo_tx(`3380632222_94_4_94_57_11`, "Failed to connect to MongoDB:", error));
        // Provide more helpful error messages
        if (error.code === "ECONNREFUSED") {
            /* eslint-disable */ console.error(...oo_tx(`3380632222_98_6_104_7_11`, "❌ MongoDB connection refused. Please check:\n" + "1. Your MongoDB Atlas cluster is running\n" + "2. Your IP address is whitelisted in MongoDB Atlas\n" + "3. Your connection string is correct\n" + "4. Your network connection is working"));
        } else if (error.name === "MongoServerError") {
            /* eslint-disable */ console.error(...oo_tx(`3380632222_106_6_106_61_11`, "❌ MongoDB server error:", error.message));
        } else if (error.name === "MongoNetworkError") {
            /* eslint-disable */ console.error(...oo_tx(`3380632222_108_6_108_62_11`, "❌ MongoDB network error:", error.message));
        }
        throw error;
    }
}
...
function optimizeContentData(content) {
    if (!content || typeof content !== 'object') {
        /* eslint-disable */ console.log(...oo_oo(`3416725212_43_4_43_68_4`, "⚠️ optimizeContentData: Invalid content:", content));
        return content;
    }
    const optimized = {
        ...content
    ...
    if (optimized.hero) {
        /* eslint-disable */ console.log(...oo_oo(`3416725212_51_4_55_6_4`, "🔍 Optimizing hero section:", {
        ...
        /* eslint-disable */ console.log(...oo_oo(`3416725212_67_4_67_48_4`, "⚠️ No hero section in content"));
    }
...
async function GET() {
    try {
        ...
        const dbOperation = async ()=>{
            ...
            const [orderSettings, settingsData, contentData, heroContentData, spotlightContentData1] = await Promise.all([
            ...
            return {
                ...
                contentData,
                heroContentData,
                spotlightContentData: spotlightContentData1
            };
        };
        // Wrap with timeout
        ...
        const { orderSettings, settingsData, contentData, heroContentData } = await Promise.race([
            dbOperation(),
            timeoutPromise
        ]);
        ...
        /* eslint-disable */ console.log(...oo_oo(`3416725212_180_4_194_6_4`, "🔍 Homepage API Response:", {
        ...
        /* eslint-disable */ console.error(...oo_tx(`3416725212_204_4_204_61_11`, "Error fetching homepage settings:", error));
...
async function PUT(request) {
    try {
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`3416725212_233_6_233_62_11`, "Error parsing request body:", parseError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`3416725212_302_6_302_58_11`, "Database connection error:", dbError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`3416725212_316_6_316_55_11`, "Authentication error:", authError));
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        try {
            const saveOperation = async ()=>{
                ...
                const saveWithRetry = async (key, value, type, maxRetries = 2)=>{
                    for(let attempt = 1; attempt <= maxRetries; attempt++){
                        try {
                            /* eslint-disable */ console.log(...oo_oo(`3416725212_341_14_341_96_4`, `💾 Saving ${type} to database... (Attempt ${attempt}/${maxRetries})`));
                            ...
                            /* eslint-disable */ console.log(...oo_oo(`3416725212_349_14_349_56_4`, `✅ ${type} saved to database`));
                            return result;
                        } catch (error) {
                            /* eslint-disable */ console.error(...oo_tx(`3416725212_352_14_352_104_11`, `❌ Failed to save ${type} to database (Attempt ${attempt}):`, error.message));
                ...
                if (heroToSave !== null) {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`3416725212_389_10_399_12_4`, "💾 Saving hero section to database (separate setting):", {
                        heroSection: {
                            hasMainArticle: !!optimizedHero?.mainArticle,
                ...
                if (spotlightToSave !== null) {
                    ...
                    /* eslint-disable */ console.log(...oo_oo(`3416725212_408_10_413_12_4`, "💾 Saving spotlight section to database (separate setting):", {
                        spotlightSection: {
            ...
            /* eslint-disable */ console.error(...oo_tx(`3416725212_433_6_433_59_11`, "Database operation error:", dbOpError));
            /* eslint-disable */ console.error(...oo_tx(`3416725212_434_6_434_56_11`, "Save results so far:", saveResults));
        ...
        /* eslint-disable */ console.error(...oo_tx(`3416725212_461_4_461_59_11`, "Error saving homepage settings:", error));
        /* eslint-disable */ console.error(...oo_tx(`3416725212_462_4_462_46_11`, "Error stack:", error.stack));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00189418._.js.map