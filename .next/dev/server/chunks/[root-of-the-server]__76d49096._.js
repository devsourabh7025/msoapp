...
"[project]/app/api/settings/featured/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (featuredContentData?.value) {
            if (typeof featuredContentData.value === 'object' && !Array.isArray(featuredContentData.value)) {
                ...
                featuredContent = {
                    smbStories: Array.isArray(featuredContentData.value.smbStories) ? featuredContentData.value.smbStories.map(optimizePostData) : [],
                    herStories: Array.isArray(featuredContentData.value.herStories) ? featuredContentData.value.herStories.map(optimizePostData) : [],
                    socialStories: Array.isArray(featuredContentData.value.socialStories) ? featuredContentData.value.socialStories.map(optimizePostData) : []
                };
    ...
    try {
        ...
        if (featured !== undefined && featured !== null) {
            if (typeof featured === 'object' && !Array.isArray(featured)) {
                // New format: object with subsections
                featuredToSave = {
                    smbStories: Array.isArray(featured.smbStories) ? featured.smbStories.map(optimizePostData) : [],
                    herStories: Array.isArray(featured.herStories) ? featured.herStories.map(optimizePostData) : [],
                    socialStories: Array.isArray(featured.socialStories) ? featured.socialStories.map(optimizePostData) : []
                };
        ...
        if (settings) {
            const settingsData = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Settings$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                key: "homepageSectionSettings"
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76d49096._.js.map