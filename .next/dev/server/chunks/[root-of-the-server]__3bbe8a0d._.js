...
"[project]/app/api/superadmin/users/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '../../../../../lib/moongoose'");
...
async function GET(request) {
    ...
    try {
        await ensureConnected(); // Connection should already exist from login
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).select("-password").sort({
            createdAt: -1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            users
        ...
        /* eslint-disable */ console.error(...oo_tx(`1233026193_52_4_52_49_11`, "Error fetching users:", error));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request) {
    ...
    try {
        ...
        const { userId, name, email, role, autoShareEnabled, socialMediaSettings } = body;
        await ensureConnected(); // Connection should already exist from login
        const updateData = {};
        ...
        /* eslint-disable */ console.error(...oo_tx(`1233026193_99_4_99_48_11`, "Error updating user:", error));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(userId);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "User deleted successfully"
        });
    } catch (error) {
        /* eslint-disable */ console.error(...oo_tx(`1233026193_141_4_141_48_11`, "Error deleting user:", error));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3bbe8a0d._.js.map