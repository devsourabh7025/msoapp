...
"[project]/app/explore/[category]/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CategoryPage() {
    ...
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("publishedAt");
    ...
    const category = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryPage.useMemo[category]": ()=>{
            if (!categorySlug) return "";
            // Convert slug back to category name (e.g., "startup-news" -> "Startup News")
            return categorySlug.split("-").map({
                "CategoryPage.useMemo[category]": (word)=>word.charAt(0).toUpperCase() + word.slice(1)
            }["CategoryPage.useMemo[category]"]).join(" ");
        }
    }["CategoryPage.useMemo[category]"], [
        categorySlug
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CategoryPage.useEffect": ()=>{
            const fetchPosts = {
                "CategoryPage.useEffect.fetchPosts": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        if (categoriesResponse.ok) {
                            ...
                            const foundCategory = categoriesData.categories?.find({
                                "CategoryPage.useEffect.fetchPosts": (cat)=>cat.name.toLowerCase() === category.toLowerCase()
                            }["CategoryPage.useEffect.fetchPosts"]);
                            if (foundCategory) {
                        ...
                        /* eslint-disable */ console.error(...oo_tx(`4193357803_66_8_66_53_11`, "Error fetching posts:", error));
                        setPosts([]);
                    } finally{
                        setLoading(false);
                    }
    ...
    const filteredPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryPage.useMemo[filteredPosts]": ()=>{
            if (!searchQuery.trim()) return posts;
            const query = searchQuery.toLowerCase();
            return posts.filter({
                "CategoryPage.useMemo[filteredPosts]": (post)=>post.title?.toLowerCase().includes(query) || post.excerpt?.toLowerCase().includes(query) || post.category?.toLowerCase().includes(query)
            }["CategoryPage.useMemo[filteredPosts]"]);
        }
    }["CategoryPage.useMemo[filteredPosts]"], [
        posts,
...
_s(CategoryPage, "K7XzojRhjZpffEhJZzuZsz7VrEw=", false, function() {
    return [
...
//# sourceMappingURL=_76d237ae._.js.map