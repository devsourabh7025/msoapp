                        ...
                        if ("TURBOPACK compile-time truthy", 1) {
                            ...
                            if (savedContent) {
                                try {
                                    ...
                                    console.error("Error parsing header content:", parseError);
                                }
                            }
                        }
                    }
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        ...
                        if (savedContent) {
                            try {
                                ...
                                console.error("Error parsing spotlight content:", error);
                            }
                        }
                    }
                }
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        ...
                        if (savedContent) {
                            try {
                                ...
                                console.error("Error parsing featured content:", error);
                                setFeaturedContent({
                                    smbStories: [],
                                    herStories: [],
                                    socialStories: []
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (data && Array.isArray(data.categories)) {
                                ...
                                console.warn("Categories data format unexpected:", data);
                                setCategories([]);
                            }
                        } else {
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        ...
                        if (savedContent) {
                            try {
                                ...
                                console.error("Error parsing trending content:", error);
                                setTrendingContent([]);
                            }
                        } else {
                            setTrendingContent([]);
            ...
            const loadDiscoverContent = {
                "DiscoverMore.useEffect.loadDiscoverContent": async ()=>{
                    try {
                        ...
                        console.error("Error loading discover content from API:", error);
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        const savedContent = localStorage.getItem("homepageSectionContent");
                        if (savedContent) {
                            try {
                                ...
                                console.error("Error parsing discover content:", error);
                            }
                        }
        ...
        "Recent.useEffect": ()=>{
            ...
            const loadRecentPosts = {
                "Recent.useEffect.loadRecentPosts": async ()=>{
                    try {
                        setLoading(true);
                        const response = await fetch("/api/public/posts?limit=6&sort=publishedAt");
                        if (response.ok) {
                            const data = await response.json();
            ...
            loadRecentPosts();
            // Refresh every 60 seconds to get new posts
            const interval = setInterval(loadRecentPosts, 60000);
            return ({
                "Recent.useEffect": ()=>{
                    clearInterval(interval);
                }
...
function Home() {
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (data.order && Array.isArray(data.order)) {
                                // Filter out header, footer, and recent (they are always fixed)
                                // Recent is always shown and not customizable
                    ...
                    if ("TURBOPACK compile-time truthy", 1) {
                        ...
                        if (savedOrder) {
                            try {
                                ...
                                console.error("Error parsing section order:", error);
                            }
                        }
                    }
                }
    ...
    const renderSections = ()=>{
        const sections = sectionOrder.filter((section)=>section.enabled).map((section)=>{
        ...
        // Always add Recent section at the end (not customizable)
        return [
            ...sections,
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Recent$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, "recent", false, {
                fileName: "[project]/app/page.jsx",
                lineNumber: 103,
                columnNumber: 26
            }, this)
...
//# sourceMappingURL=_a34336e5._.js.map