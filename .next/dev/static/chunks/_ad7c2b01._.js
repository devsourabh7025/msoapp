...
function Navbar() {
    ...
    const checkAuth = async ()=>{
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`3592695437_62_6_62_48_11`, "Auth check failed:", error));
        } finally{
            setLoading(false);
        }
    };
    const handleLogout = async ()=>{
        try {
            ...
            /* eslint-disable */ console.error(...oo_tx(`3592695437_76_6_76_44_11`, "Logout failed:", error));
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Navbar.useEffect": ()=>{
            // Load header content from API (database)
                            ...
                            if ("TURBOPACK compile-time truthy", 1) {
                                ...
                                if (savedContent) {
                                    try {
                                        ...
                                        /* eslint-disable */ console.error(...oo_tx(`3592695437_115_16_115_69_11`, "Error parsing header content:", error));
                                    }
                                }
                            }
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`3592695437_121_8_121_61_11`, "Error loading header content:", error));
                        ...
                        if ("TURBOPACK compile-time truthy", 1) {
                            ...
                            if (savedContent) {
                                try {
                                    ...
                                    /* eslint-disable */ console.error(...oo_tx(`3592695437_132_14_132_72_11`, "Error parsing header content:", parseError));
                                }
                            }
                        }
                    }
            ...
            const interval = setInterval(loadHeaderContent, 30000);
            return ({
                "Navbar.useEffect": ()=>{
...
_s(Navbar, "6Q93mg8/tEW+dyNuIdsMU40tnuo=", false, function() {
    return [
...
function HeroFeatured() {
    ...
    const handleNewsletterSubmit = (e)=>{
        ...
        /* eslint-disable */ console.log(...oo_oo(`1105975709_24_4_24_44_4`, "Newsletter signup:", email));
        setEmail("");
    };
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HeroFeatured.useEffect": ()=>{
            // Load hero content from API (database)
            const loadHeroContent = {
                "HeroFeatured.useEffect.loadHeroContent": async ()=>{
                    try {
                        ...
                        /* eslint-disable */ console.error(...oo_tx(`1105975709_43_8_43_68_11`, "Error loading hero content from API:", error));
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        const savedContent = localStorage.getItem("homepageSectionContent");
                        if (savedContent) {
                            try {
                                ...
                                if (parsed.hero) {
                                    ...
                                    setHeroContent({}); // Empty object if no hero content
                                }
                            } catch (error) {
                                /* eslint-disable */ console.error(...oo_tx(`1105975709_58_12_58_63_11`, "Error parsing hero content:", error));
                                setHeroContent({}); // Empty object on error
                            }
                        } else {
                            setHeroContent({}); // Empty object if no localStorage data
                        }
    ...
    const { topPicks, mainArticle, capTableArticles } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "HeroFeatured.useMemo": ()=>{
            ...
            return {
                ...
                capTableArticles: heroContent?.capTable && heroContent.capTable.length > 0 ? heroContent.capTable : []
            };
        }
    }["HeroFeatured.useMemo"], [
        heroContent
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            capTableArticles.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "bg-gray-50 dark:bg-slate-800/50 p-6 rounded-lg border border-gray-200 dark:border-slate-700 mb-8 text-center",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        className: "text-gray-500 dark:text-gray-400 text-sm",
                                        children: "No CapTable articles selected"
                                    }, void 0, false, {
                                        fileName: "[project]/components/HeroFeatured.jsx",
                                        lineNumber: 260,
                                        columnNumber: 17
...
_s(HeroFeatured, "GC9XxkCtRjkAdkZylGNBy4U+1x0=");
_c = HeroFeatured;
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
function oo_cm() {
    try {
...
function SpotLight() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SpotLight.useEffect": ()=>{
            // Load spotlight content from API (database)
            const loadSpotlightContent = {
                "SpotLight.useEffect.loadSpotlightContent": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            const data = await response.json();
                            if (data.content && data.content.spotlight) {
                                setSpotlightContent(data.content.spotlight);
                                return;
                            }
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`2904365166_24_8_24_73_11`, "Error loading spotlight content from API:", error));
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        const savedContent = localStorage.getItem("homepageSectionContent");
                        if (savedContent) {
                            try {
                                ...
                                /* eslint-disable */ console.error(...oo_tx(`2904365166_37_12_37_68_11`, "Error parsing spotlight content:", error));
                            }
                        }
                    }
                }
            ...
            // Refresh every 30 seconds to get updates
            const interval = setInterval(loadSpotlightContent, 30000);
            return ({
                "SpotLight.useEffect": ()=>{
                    clearInterval(interval);
                }
...
_s(SpotLight, "ZDvYCNpaNBoGu0i2/yMPwfvtUUo=");
_c = SpotLight;
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
function oo_cm() {
    try {
...
function Featured() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Featured.useEffect": ()=>{
            // Load featured content from API (database)
            const loadFeaturedContent = {
                "Featured.useEffect.loadFeaturedContent": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            const data = await response.json();
                            if (data.content && data.content.featured) {
                                setFeaturedContent(data.content.featured);
                                return;
                            }
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`2578408991_24_8_24_72_11`, "Error loading featured content from API:", error));
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        const savedContent = localStorage.getItem("homepageSectionContent");
                        if (savedContent) {
                            try {
                                const parsed = JSON.parse(savedContent);
                                if (parsed.featured) {
                                    setFeaturedContent(parsed.featured);
                                } else {
                                    setFeaturedContent({
                                        smbStories: [],
                                        herStories: [],
                                ...
                                /* eslint-disable */ console.error(...oo_tx(`2578408991_39_12_39_67_11`, "Error parsing featured content:", error));
                                setFeaturedContent({
                                    smbStories: [],
                                    herStories: [],
                                    socialStories: []
...
_s(Featured, "sOoRuCV4GmatwzZl7wXitlTwngg=");
_c = Featured;
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
function oo_cm() {
    try {
                ...
                "Explore.useEffect.fetchCategories": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            ...
                            /* eslint-disable */ console.error(...oo_tx(`983465522_20_10_20_53_11`, "Failed to fetch categories"));
                            setCategories([]);
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`983465522_24_8_24_58_11`, "Error fetching categories:", error));
                        setCategories([]);
                    } finally{
                        setLoading(false);
                    }
...
function TrendingNow() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrendingNow.useEffect": ()=>{
            // Load trending content from API (database)
            const loadTrendingContent = {
                "TrendingNow.useEffect.loadTrendingContent": async ()=>{
                    try {
                        ...
                        if (response.ok) {
                            const data = await response.json();
                            if (data.content && data.content.trending) {
                                setTrendingContent(data.content.trending);
                                return;
                            }
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`3956315831_24_8_24_72_11`, "Error loading trending content from API:", error));
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        const savedContent = localStorage.getItem("homepageSectionContent");
                        if (savedContent) {
                            try {
                                ...
                                /* eslint-disable */ console.error(...oo_tx(`3956315831_39_12_39_67_11`, "Error parsing trending content:", error));
                                setTrendingContent([]);
                            }
                        } else {
                            setTrendingContent([]);
            ...
            loadTrendingContent();
            // Refresh every 30 seconds to get updates
            const interval = setInterval(loadTrendingContent, 30000);
            return ({
                "TrendingNow.useEffect": ()=>{
                    clearInterval(interval);
                }
...
_s(TrendingNow, "EJ22f27ldW4m0zJ+2ucSrTceHLw=");
_c = TrendingNow;
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
function oo_cm() {
    try {
...
function DiscoverMore() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DiscoverMore.useEffect": ()=>{
            // Load discover content from API (database)
            const loadDiscoverContent = {
                "DiscoverMore.useEffect.loadDiscoverContent": async ()=>{
                    try {
                        const response = await fetch("/api/settings/homepage");
                        if (response.ok) {
                            const data = await response.json();
                            if (data.content && data.content.discover && Array.isArray(data.content.discover) && data.content.discover.length > 0) {
                                setCategories(data.content.discover);
                                return;
                            }
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`3694824260_23_8_23_72_11`, "Error loading discover content from API:", error));
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        const savedContent = localStorage.getItem("homepageSectionContent");
                        if (savedContent) {
                            try {
                                const parsed = JSON.parse(savedContent);
                                if (parsed.discover && Array.isArray(parsed.discover) && parsed.discover.length > 0) {
                                    setCategories(parsed.discover);
                                    return;
                                }
                            } catch (error) {
                                /* eslint-disable */ console.error(...oo_tx(`3694824260_37_12_37_67_11`, "Error parsing discover content:", error));
                            }
                        }
                        ...
                        setCategories([
                            {
                                ...
                                links: [
                                    {
                                        id: "1",
                                        title: "How Speedata Is Powering Next Gen AI and Big Data With APU Chips",
                                        url: "/posts/startup-1"
                                    },
                                    {
                                        id: "2",
                                        title: "SGA marks 15 years of redefining communications consulting in India",
                                        url: "/posts/startup-2"
                                    },
                                    {
                                        id: "3",
                                        title: "From Hackathon to Lifesaving: How EmerReady Prepares Kids for...",
                                        url: "/posts/startup-3"
                                    },
                                    {
                                        id: "4",
                                        title: "Woven by tradition: How Taavi is bringing India's craft heritage into the...",
                                        url: "/posts/startup-4"
                                    }
                                ]
                            },
                            {
                                ...
                                links: [
                                    {
                                        id: "1",
                                        title: "Outlook 2026: India's semiconductor push clears capacity hurdle",
                                        url: "/posts/tech-1"
                                    },
                                    {
                                        id: "2",
                                        title: "India launches DHRUV64, first indigenously designed 1.0 GHz 64-bit",
                                        url: "/posts/tech-2"
                                    },
                                    {
                                        id: "3",
                                        title: "Build an AI-powered business with 40% off on Salesforce's core platforms",
                                        url: "/posts/tech-3"
                                    },
                                    {
                                        id: "4",
                                        title: "Tata, Intel sign MoU to build India centred silicon and compute ecosystem",
                                        url: "/posts/tech-4"
                                    }
                                ]
                            },
                            {
                                ...
                                links: [
                                    {
                                        id: "1",
                                        title: "5 Profitable small business ideas for new founders",
                                        url: "/posts/business-1"
                                    },
                                    {
                                        id: "2",
                                        title: "This Indian Tree Can Make You Richer Than Sugarcane or Wheat",
                                        url: "/posts/business-2"
                                    },
                                    {
                                        id: "3",
                                        title: "The Day KFC Ran Out of Chicken - And Turned Crisis into a Comeback",
                                        url: "/posts/business-3"
                                    },
                                    {
                                        id: "4",
                                        title: "Meet the 10 entrepreneurs set to drive change in 2025",
                                        url: "/posts/business-4"
                                    }
                                ]
                            },
                            {
                                ...
                                links: [
                                    {
                                        id: "1",
                                        title: "These businesses are turning traditional Indian sweets into health conscious",
                                        url: "/posts/resources-1"
                                    },
                                    {
                                        id: "2",
                                        title: "How brands are blending tech with tradition this Ganesh Chaturthi 2025",
                                        url: "/posts/resources-2"
                                    },
                                    {
                                        id: "3",
                                        title: "What to consider before taking a business loan?",
                                        url: "/posts/resources-3"
                                    },
                                    {
                                        id: "4",
                                        title: "Must read business newsletters: An entrepreneur's secret weapon",
                                        url: "/posts/resources-4"
                                    }
                                ]
                            }
                        ]);
            ...
            }["DiscoverMore.useEffect.loadDiscoverContent"];
            loadDiscoverContent();
            // Refresh every 30 seconds to get updates
            const interval = setInterval(loadDiscoverContent, 30000);
            return ({
                "DiscoverMore.useEffect": ()=>{
                    clearInterval(interval);
                }
                ...
                categories.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: categories.map((category, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                category.links && category.links.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                    className: "space-y-3",
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-xs text-gray-400 dark:text-gray-500 mt-1",
                            children: "Add categories and links in the admin panel"
                        }, void 0, false, {
                            fileName: "[project]/components/DiscoverMore.jsx",
                            lineNumber: 146,
                            columnNumber: 13
...
_s(DiscoverMore, "+ijgB8ROEl0Dkz53OTIi8GynN6s=");
_c = DiscoverMore;
/* istanbul ignore next */ /* c8 ignore start */ /* eslint-disable */ ;
function oo_cm() {
    try {
...
function Footer() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Footer.useEffect": ()=>{
                            ...
                            if ("TURBOPACK compile-time truthy", 1) {
                                ...
                                if (savedContent) {
                                    try {
                                        ...
                                        /* eslint-disable */ console.error(...oo_tx(`497311526_32_16_32_69_11`, "Error parsing footer content:", error));
                                    }
                                }
                            }
                        }
                    } catch (error) {
                        /* eslint-disable */ console.error(...oo_tx(`497311526_38_8_38_61_11`, "Error loading footer content:", error));
                        // Fallback to localStorage
                        if ("TURBOPACK compile-time truthy", 1) {
                            const savedContent = localStorage.getItem("homepageSectionContent");
                            if (savedContent) {
                                try {
                                    ...
                                    /* eslint-disable */ console.error(...oo_tx(`497311526_49_14_49_72_11`, "Error parsing footer content:", parseError));
                                }
                            }
                        }
                    }
            ...
            loadFooterContent();
            // Refresh every 30 seconds to get updates
            const interval = setInterval(loadFooterContent, 30000);
            return ({
                "Footer.useEffect": ()=>{
                    clearInterval(interval);
                }
    ...
    const startupPrograms = footerContent?.startupPrograms || [];
    const community = footerContent?.community || [];
    const quickAccess = footerContent?.quickAccess || [];
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    (startupPrograms.length > 0 || community.length > 0 || quickAccess.length > 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-slate-700/50",
                        children: [
                            startupPrograms.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        ...
                                        children: startupPrograms.map((link, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    href: link.url || "/",
                            ...
                            community.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h5", {
                                        className: "text-white font-semibold mb-4 text-sm uppercase tracking-wider",
                                        children: "Community"
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-2 text-sm text-gray-400",
                                        children: community.map((link, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    href: link.url || "/",
                                                    className: "hover:text-red-400 transition-colors",
                                                    children: link.title
                            ...
                            quickAccess.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h5", {
                                        className: "text-white font-semibold mb-4 text-sm uppercase tracking-wider",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        className: "space-y-2 text-sm text-gray-400",
                                        children: quickAccess.map((link, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    href: link.url || "/",
                                                    className: "hover:text-red-400 transition-colors",
                                                    children: link.title
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            // Load section order from API (database)
                    ...
                    try {
                        ...
                        if (response.ok) {
                            ...
                            if (data.order && Array.isArray(data.order)) {
                                // Filter out header and footer (they are always fixed)
                                const filtered = data.order.filter({
                                    "Home.useEffect.loadSectionOrder.filtered": (s)=>s.id !== "header" && s.id !== "footer"
                        ...
                        /* eslint-disable */ console.error(...oo_tx(`1252919457_51_8_51_69_11`, "Error loading section order from API:", error));
                    }
                    // Fallback to localStorage
                    if ("TURBOPACK compile-time truthy", 1) {
                        ...
                        if (savedOrder) {
                            try {
                                ...
                                /* eslint-disable */ console.error(...oo_tx(`1252919457_64_12_64_64_11`, "Error parsing section order:", error));
                            }
                        }
                    }
                }
            ...
            loadSectionOrder();
            // Refresh every 30 seconds to get updates
            const interval = setInterval(loadSectionOrder, 30000);
            return ({
...
//# sourceMappingURL=_ad7c2b01._.js.map